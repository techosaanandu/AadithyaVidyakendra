...
//         <ul className="absolute z-10 w-full bg-white/90 text-black rounded-xl mt-1 max-h-60 overflow-y-auto shadow-lg">
...
//     setInputValue(name.label);
//     onSelectName(name); // Pass the selected name to the parent component
//     setIsOpen(false); // Close the dropdown
//   };

//   return (
//     <div className="relative mb-4"> {/* Add margin-bottom to create space */}
//       <input
//         type="text"
//         placeholder="Search Student Name..."
//         className="w-full p-2 border border-white/30 bg-white/10 text-black placeholder-gray-800 rounded-xl outline-none focus:border-blue-300 transition-all duration-300"
