...
// import "react-toastify/dist/ReactToastify.css";
// import SearchFilter from "../components/SearchFilter";
// // import SearchFilter from "@/components/SearchFilter"; // Adjust path if needed
// import NameSearchFilter from "../components/NameSearchFilter"; // Adjust path if needed
// import { FaDownload, FaEye } from "react-icons/fa";
// import { createClient } from "@supabase/supabase-js";
...
//         <div className="mb-4">
//           <NameSearchFilter selectedSchool={selectedSchool} onSelectName={setStudentName} />
//         </div>
...
//         {downloadLinks.length > 0 && (
//           <div className="mt-6">
//            Presented by <h2 className="text-lg font-semibold text-white mb-2">📜 Available PDFs:</h2>
//             <ul className="space-y-2">
//               {downloadLinks.map((link, index) => (
//                 <li key={index} className="flex justify-between items-center bg-white/10 p-2 rounded-lg">
//                   <a href={link.url} download className="block text-blue-300 hover:text-white transition-all duration-300">
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-blue-950 bg-cover bg-center" style={{ backgroundImage: "url('/backgroundd.jpg')" }}>
      <div className="bg-white/10 backdrop-blur-sm shadow-xl rounded-2xl p-8 w-96 border border-white/20">
        ...
        <select
          className="w-full p-2 border border-white/30 bg-white/10 text-white placeholder-gray-800 rounded-xl outline-none focus:border-blue-300 transition-all duration-300"
          value={studentClass}
          onChange={(e) => setStudentClass(e.target.value)}
        >
        ...
        <input
          type="text"
          placeholder="Enter Student Roll No"
          className="w-full p-2 mt-3 border border-white/30 bg-white/10 text-white placeholder-amber-50 rounded-xl outline-none focus:border-blue-300 transition-all duration-300"
          value={studentRoll}
          onChange={(e) => setStudentRoll(e.target.value)}
        />
